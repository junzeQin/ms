            ...
            <el-card class="project-info-card">
              <div class="project-info-card-div shepherd-project-name">
                ...
                <el-row class="project-item">
                  <span class="project-item-title" style="float: left;">{{ $t('project.desc') }}：</span>
                  <el-popover placement="right" width="400" trigger="hover">
                    <div v-html="project.description" style="white-space: break-spaces;"></div>
                    <div slot="reference" class="project-item-desc project-desc" style="float: left;line-height: 16px;">{{ project.description }}</div>
                  </el-popover>
                  <!-- <el-tooltip effect="light" placement="top" :enterable="false">
                    <div slot="content" v-html="project.description"></div>
