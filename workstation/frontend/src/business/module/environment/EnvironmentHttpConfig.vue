  ...
  <el-form :model="condition" :rules="rules" ref="httpConfig" class="ms-el-form-item__content" :disabled="isReadOnly">
    <div class="ms-border">
      ...
      <el-form-item prop="enable">
        ...
        <el-row>
          <el-link class="ms-el-link" @click="batchAdd" style="color: #315efb"> {{ $t("commons.batch_add") }}</el-link>
        </el-row>
...
import {getApiModuleByProjectIdAndProtocol} from "@/api/definition-module";
import MsApiKeyValue from "@/business/module/api/ApiKeyValue";
...
import Vue from "vue";
import BatchAddParameter from "@/business/module/api/BatchAddParameter";
