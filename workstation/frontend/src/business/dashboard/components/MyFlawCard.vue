...
export default {
  ...
  data() {
    return {
      ...
      weekTotalCount: 0,
      subtextStr:"",
      color:['#19ff00', '#F290C8','#FAD355','#FFE668', '#14E1C6','#4CFDE0', '#4E83FD','#96BDFF', '#50CEFB', '#76F0FF','#935AF6','#DC9BFF','#FFA53D','#FFC75E','#F76964','#FF9E95','#F14BA9','#FF89E3','#C3DD40','#D9F457','#616AE5','#ACADFF','#62D256','#87F578'],
      textColor:'#263238',
