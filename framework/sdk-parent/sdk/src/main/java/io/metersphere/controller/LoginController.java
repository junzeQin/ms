...
import static io.metersphere.commons.constants.CommonConstants.METER_SPHERE_LOGIN_USER_SESSION_KEY;
import static io.metersphere.commons.constants.CommonConstants.METER_SPHERE_USER_CSRF_TOKEN_KEY;
import static io.metersphere.commons.constants.CommonConstants.METER_SPHERE_USER_SESSION_ID_KEY;
...
public class LoginController {
    ...
    public void logout(HttpServletResponse response) throws Exception {
        ...
        if (null != subject) {
            ...
            if (null != principal) {
                var loginUserSessionKey = METER_SPHERE_LOGIN_USER_SESSION_KEY + String.valueOf(principal);
                stringRedisTemplate.opsForHash().delete(loginUserSessionKey, METER_SPHERE_USER_SESSION_ID_KEY, METER_SPHERE_USER_CSRF_TOKEN_KEY);
            }
            subject.logout();
        }
    }
