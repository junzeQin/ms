...
// 测试跟踪-缺陷管理-缺陷列表
export const TEST_TRACK_ISSUE_LIST = [NAME, CREATE_TIME, UPDATE_TIME, CREATOR,PLATFORM_STATUS];

// 测试跟踪-测试用例-关联缺陷
export const TEST_CASE_RELEVANCE_ISSUE_LIST = [NAME, CREATE_TIME, CREATOR];
