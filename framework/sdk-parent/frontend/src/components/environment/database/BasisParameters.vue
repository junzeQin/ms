...
import {getUUID, objToStrMap} from "../../../utils";
import {getCurrentProjectID} from "../../../utils/token";
import MsJsr233Processor from "../commons/Jsr233Processor";
import {hisDataProcessing, stepCompute} from "../../../model/Setting";
import {environmentList, getEnvironmentByProjectId} from "../../../api/environment";
...
export default {
  ...
  methods: {
    ...
    itselfEnvironment(environmentId) {
      ...
      this.result = environmentList(id).then(response => {
