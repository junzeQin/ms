...
<script>
import {definitionRawToXML} from "../../../api/environment";
...
import TCPSampler from "./tcp-sampler";
import {getUUID} from "../../../utils";
import {getCurrentProjectID} from "../../../utils/token";
import MsApiVariable from "../commons/ApiVariable";
import Jsr233ProcessorContent from "../commons/Jsr233ProcessorContent";
import ApiDefinitionStepButton from "../commons/ApiDefinitionStepButton";
import TcpXmlTable from "./TcpXmlTable";
import {TYPE_TO_C} from "../../../model/Setting";
import {hisDataProcessing, stepCompute} from "../../../model/Setting";
...
export default {
  ...
  methods: {
    toXml() {
      this.result = definitionRawToXML({"stringData": this.request.rawDataStruct}).then(response => {
        if (response.data) {
