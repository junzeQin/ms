...
const message = {
  commons: {
    ...
    enterprise_edition_tips:
      "This is an enterprise edition feature, <a href='https://neuedu.com' target='_blank'>please consult for details</a>",
    ui_edition_tips:
  ...
  organization: {
    ...
    integration: {
      ...
      input_jira_url:
        "Please enter Jira address, for example: https://neuedu.atlassian.net/",
      ...
      use_tip_two:
        "After saving the Basic Auth account information, you need to manually associate the ID/key and issue template in the Neuedu project",
  ...
  report: {
    ...
    export: "Export",
    export_to_ms_format: "Export to Neuedu format",
  ...
  api_test: {
    ...
    api_import: {
      ...
      ms_tip: "Support for Neuedu JSON format",
      support_format: "Support p12, jks, pfx format",
      ms_export_tip:
        "Export jSON-formatted files via Neuedu website or browser plug-ins",
      ...
      ms_env_import_file_limit:
        "It only supports JSON format files exported through neuedu",
  ...
  ui: {
    ...
    selenium_export_tip: "Export side file via Neuedu",
  ...
  shepherd: {
    step1: {
      ...
      text: "Neuedu uses [workspace] and [project] to isolate test data, and you can switch between workspace and project in the top menu.",
    },
    step2: {
    ...
    step3: {
      ...
      text: 'A "project" is a collection of use cases and members. Various types of tests on Neuedu are viewed and managed through projects.',
    },
    step4: {
  ...
  guide: {
    home: {
      title: "Welcome to Neuedu!",
      desc: "A quickstart guide to see what Neuedu can do for you.",
