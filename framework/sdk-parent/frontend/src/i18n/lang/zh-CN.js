...
const message = {
  commons: {
    ...
    enterprise_edition_tips:
      "此功能为企业版功能，<a href='https://neuedu.com' target='_blank'>详情请咨询</a>",
  ...
  custom_field: {
    ...
    case_priority_option_check_error: "用例优先级需按照顺序添加选项值, 例: P",
  ...
  organization: {
    ...
    integration: {
      ...
      input_jira_url: "请输入Jira地址，例：https://neuedu.atlassian.net/",
      ...
      use_tip_two:
        "保存 Basic Auth 账号信息后，需要在 Neuedu 项目中手动关联 ID/key 和缺陷模板",
  ...
  report: {
    ...
    export: "导出",
    export_to_ms_format: "导出 Neuedu 格式",
  ...
  api_test: {
    ...
    definition: {
      ...
      request: {
        ...
        grade_info: "按等级筛选",
        grade_order_asc: "按用例优先级从低到高",
        grade_order_desc: "按用例优先级从高到低",
    ...
    api_import: {
      ...
      tip: "说明",
      export_tip: "导出方法",
      ms_tip: "支持 Neuedu json 格式",
      ms_export_tip:
        "通过 Neuedu 接口测试页面或者浏览器插件导出 json 格式文件",
      ...
      ms_env_import_file_limit: "仅支持通过 Neuedu 导出的 json 格式文件",
    ...
    home_page: {
      ...
      formula: {
        ...
        review: "已评审的功能用例/所有功能用例 * 100%",
        testplan_coverage: "关联的功能用例/所有功能用例 * 100%",
  ...
  ui: {
    ...
    selenium_export_tip: "通过 Neuedu 导出 side 文件",
    elementObject: "元素对象",
    elementLocator: "元素定位",
    elementType: "所属分类",
    not_selected: "(未选择元素)",
  ...
  shepherd: {
    step1: {
      title: "工作空间和项目",
      text: "Neuedu 使用 [工作空间] 和 [项目] 来隔离测试数据, 你可以在顶部菜单进行工作空间和项目切换。",
    },
    step2: {
      title: "功能主菜单",
      text: "主菜单显示你所在的功能模块。",
    ...
    step3: {
      title: "一个空间可以创建多个项目",
      text: "「项目」是一组用例和成员的集合。Neuedu 上各种类型的测试均通过项目进行分权分域查看和管理。",
    },
    step4: {
      title: "一级功能菜单",
  ...
  guide: {
    home: {
      title: "欢迎来到 Neuedu！",
      desc: "通过一个快捷指引来了解 Neuedu 究竟能为你做哪些事。",
      button: "让我们开始吧",
    },
    test: {
      title: "测试用例是测试任务的基石",
