...
const message = {
  commons: {
    ...
    enterprise_edition_tips:
      "此功能為企業版功能，<a href='https://neuedu.com' target='_blank'>詳情請諮詢</a>",
  ...
  custom_field: {
    ...
    case_priority_option_check_error: "用例優先級需按照順序添加選項值, 例: P",
  ...
  organization: {
    ...
    integration: {
      ...
      input_jira_url: "請輸入Jira地址，例：https://neuedu.atlassian.net/",
      ...
      use_tip_two:
        "保存 Basic Auth 賬號信息後，需要在 Neuedu 項目中手動關聯 ID/key 和缺陷模板",
  ...
  report: {
    ...
    export: "導出",
    export_to_ms_format: "導出 Neuedu 格式",
  ...
  api_test: {
    ...
    definition: {
      ...
      request: {
        ...
        grade_info: "按等級篩選",
        grade_order_asc: "按用例優先級從低到高",
        grade_order_desc: "按用例優先級從高到低",
    ...
    api_import: {
      ...
      ms_export_tip:
        "通過 Neuedu 接口測試頁面或者瀏覽器插件導出 json 格式文件",
      ...
      ms_env_import_file_limit: "僅支持通過 Neuedu 導出的 json 格式文件",
    ...
    home_page: {
      ...
      formula: {
        ...
        review: "已評審的功能用例/所有功能用例 * 100%",
        testplan_coverage: "關聯的功能用例/所有功能用例 * 100%",
  ...
  ui: {
    ...
    selenium_export_tip: "通過 Neuedu 導出 side 文件",
    elementObject: "元素對象",
    elementLocator: "元素定位",
    elementType: "所屬分類",
    not_selected: "(未選擇元素)",
  ...
  shepherd: {
    step1: {
      title: "工作空間和項目",
      text: "Neuedu 使用 [工作空間] 和 [項目] 來隔離測試數據, 你可以在頂部菜單進行工作空間和項目切換。",
    },
    step2: {
      title: "功能主菜單",
      text: "主菜單顯示您所在的功能模塊。",
    ...
    step3: {
      title: "一個空間可以創建多個項目",
      text: "「項目」是一組用例和成員的集合。 Neuedu 上各種類型的測試均通過項目進行分權分域查看和管理。",
    },
    step4: {
      title: "一級功能菜單",
  ...
  guide: {
    home: {
      title: "歡迎來到 Neuedu！",
      desc: "通過一個快捷指引來了解 Neuedu 究竟能為你做哪些事。",
      button: "讓我們開始吧",
    },
    test: {
      title: "測試用例是測試任務的基石",
