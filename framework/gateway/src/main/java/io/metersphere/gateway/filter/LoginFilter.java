...
public class LoginFilter implements WebFilter, Ordered {
    ...
    public void init() {
        ...
        excludePatterns.add(new PathPatternParser().parse("/pdf/web/viewer.html"));

        excludePatterns.add(new PathPatternParser().parse("/pdf/web/viewer.js"));

        excludePatterns.add(new PathPatternParser().parse("/pdf/web/viewer.css"));

        excludePatterns.add(new PathPatternParser().parse("/pdf/build/pdf.js"));
