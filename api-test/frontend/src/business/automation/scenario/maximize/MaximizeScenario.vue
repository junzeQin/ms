...
.ms-max-tree :deep(.el-tree-node__expand-icon.expanded) {
  -webkit-transform: rotate(0deg);
  transform: rotate(0deg);
}

.ms-max-tree :deep(.el-icon-caret-right:before) {
  /*content: '\e723';*/
  padding: 0;
  content: '';
}

.ms-max-tree :deep(.el-tree-node__expand-icon.is-leaf) {
  color: transparent;
}

.ms-max-tree :deep(.el-tree-node__expand-icon) {
  color: #7c3985;
}
