...
public class IssueExcelListener extends AnalysisEventListener<Map<Integer, String>> {
    ...
    private Boolean isOptionInclude(Object value, String options) {
        ...
        if (value instanceof List) {
            ...
            try {
                cn.hutool.json.JSONObject entries = JSONUtil.parseObj(options);
                for (Map.Entry<String, Object> e : entries) {
                    if (StringUtils.equals(e.getKey(), value.toString())) {
                        return true;
                    }
                    Object o = e.getValue();
                    if (null == o) {
                    ...
                    if (StringUtils.equals(o.toString(), value.toString())) {
                        return true;
                    }
                }
