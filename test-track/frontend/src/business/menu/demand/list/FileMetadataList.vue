...
import FileMetadataDialog from "@/business/menu/demand/dialog/FileMetadataDialog";
import {
  batchDeleteMetaData,
  createFileMeta,
  deleteFileMetaById,
...
export default {
  ...
  methods: {
    ...
    // 查询需求文档列表
    getProjectFiles() {
      this.tableLoading = getRequirementPages(
        this.projectId,
        this.currentPage,
        this.pageSize,
        this.condition
    ...
    handleUpload(uploadResources) {
      ...
      this.tableLoading = createFileMeta(file, request).then(() => {
