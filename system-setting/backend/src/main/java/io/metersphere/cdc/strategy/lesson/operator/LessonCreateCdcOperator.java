...
@Component()
@Slf4j
public class LessonCreateCdcOperator extends AbstractLessonCdcOperator {
    ...
    public void handle(SinkUpgradeElement<TestTrainLesson> sinkElement) {
        ...
        if (!super.validateLesson(testTrainLesson)) {
            log.warn("LessonCreateCdcOperator#handle validate lesson do not meet requirements: {}", testTrainLesson);
            return;
        }
    }
