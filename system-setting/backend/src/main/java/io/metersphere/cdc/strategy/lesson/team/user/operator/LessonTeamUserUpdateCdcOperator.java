...
@Component()
@Slf4j
public class LessonTeamUserUpdateCdcOperator extends AbstractLessonTeamUserCdcOperator {
    ...
    public void handle(SinkUpgradeElement<TestTrainLessonTeamUser> sinkElement) {
        ...
        if (!super.validateLessonTeamUser(lessonTeamUser)) {
            log.warn("LessonTeamUserUpdateCdcOperator#handle validate lesson team user do not meet requirements: {}", lessonTeamUser);
            return;
        }
