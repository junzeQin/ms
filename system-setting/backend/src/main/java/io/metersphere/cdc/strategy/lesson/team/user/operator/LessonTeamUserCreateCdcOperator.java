...
@Component()
@Slf4j
public class LessonTeamUserCreateCdcOperator extends AbstractLessonTeamUserCdcOperator {
    ...
    public void handle(SinkUpgradeElement<TestTrainLessonTeamUser> sinkElement) {
        ...
        if (!super.validateLessonTeamUser(lessonTeamUser)) {
            log.warn("LessonTeamUserCreateCdcOperator#handle validate lesson team user do not meet requirements: {}", lessonTeamUser);
            return;
        }
