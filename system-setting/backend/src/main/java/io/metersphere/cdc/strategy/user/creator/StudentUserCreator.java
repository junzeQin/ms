...
@Component
@Slf4j
public class StudentUserCreator extends AbstractUserCreator {
    ...
    public void handle(TestTrainUser testTrainUser) {
        var userRequest = testTrainUser2UserRequest(testTrainUser, UserConstants.STUDENT_USER_GROUP_IDS);
        log.info("StudentUserCreator userRequest: {}", userRequest);
