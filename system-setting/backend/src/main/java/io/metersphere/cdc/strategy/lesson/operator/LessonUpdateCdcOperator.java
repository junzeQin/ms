...
@Component()
@Slf4j
public class LessonUpdateCdcOperator extends AbstractLessonCdcOperator {
    ...
    public void handle(SinkUpgradeElement<TestTrainLesson> sinkElement) {
        ...
        if (!super.validateLesson(testTrainLesson)) {
            log.warn("LessonUpdateCdcOperator#handle validate lesson do not meet requirements: {}", testTrainLesson);
            return;
        }
    }
