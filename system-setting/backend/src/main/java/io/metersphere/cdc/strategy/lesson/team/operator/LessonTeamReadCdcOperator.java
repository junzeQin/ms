...
@Component()
@Slf4j
public class LessonTeamReadCdcOperator extends AbstractLessonTeamCdcOperator {
    ...
    public void handle(SinkUpgradeElement<TestTrainLessonTeam> sinkElement) {
        ...
        if (!super.validateLessonTeam(testTrainLessonTeam)) {
            log.warn("LessonTeamReadCdcOperator#handle validate lesson team do not meet requirements: {}", testTrainLessonTeam);
            return;
        }
