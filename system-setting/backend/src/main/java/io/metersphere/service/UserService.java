...
import io.metersphere.commons.constants.BatchProcessUserInfoType;
...
public class UserService {
    ...
    public UserDTO insert(io.metersphere.request.member.UserRequest userRequest) {
        ...
        if (user != null) {
            ...
            createUser(userRequest, userRequest.isPasswordEncode());
        }
...
//        }
    ...
    public void createUser(User userRequest, boolean passwordEncode) {
        User user = new User();
